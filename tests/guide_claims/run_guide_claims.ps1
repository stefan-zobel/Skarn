...
#
# After the claims it runs run_guide_examples.ps1 (every ```rust block of both guides) and then
# tests/run_examples.ps1 (every program under examples/, exact output), so one command is the whole doc gate.
# -NoExamples skips both, and so does a -Dir subset.
#
